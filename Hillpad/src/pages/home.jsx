...
export default function Home() {
    return (
        ...
        <section className='my-20'>
            <div>
                <h2 className='font-medium text-2xl md:text-5xl lg:font-bold lg:text-4xl'>Browse by <span className='text-orange'>Discipline</span></h2>
        ...
        <section>
            <div className='text-3xl font-medium my-8 md:text-5xl md:my-10 lg:text-4xl lg:font-semibold'>Featured <span className='text-orange'>Courses</span></div>
        ...
        <section>
            <div className='font-medium text-3xl mb-8 md:text-5xl lg:font-semibold lg:text-4xl'>Browse By <span className='text-orange'>Country</span></div>
            <div>
