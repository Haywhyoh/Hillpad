...
export default function DashboardStaff() {
    return (
        <div className="bg-grey bg-opacity-10 px-auto  w-full ">
            <div className=" flex p-y pb-0 max-w-8xl mx-auto xl:justify-center">
                <div className='hidden xl:block w-96 max-h-screen bg-white me-4'>

                </div>
                <div className="">
                   <div className='hidden xl:block bg-white m-4'>
                    <div>BAr</div>
                   </div>
                    ...
                    <div className='lg:flex justify-between'>
                        <div className="lg:w-8/12">
                            <div className="card">
                                <div className="bg-white m-4 shadow rounded-md lg:flex lg:justify-between">
                    ...
                    <div className='lg:flex justify-center'>
                        <div className="lg:w-8/12">
                            <div className="flex flex-wrap flex-col justify-center 2xs:flex-row lg:justify-between">
                                <div className="bg-white m-4 p-4 2xs:w-64 sm:w-72 rounded-md xl:w-84">
                                    <div className="">
                                        <div className="">
