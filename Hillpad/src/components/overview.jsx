...
export default function Overview({props}) {
    return (
        <div className="text-base lg:text-lg">
            ...
            <div className='flex gap-x-4 lg:gap-x-6  font-bold text-base lg:text-xl  py-2 my-4 text-opacity-40'>
            ...
            <div className='flex items-center flex-wrap gap-x-2 text-light_black lg:border-b border-light_black border-opacity-30 pt-2 pb-8'>
                ...
                <div className='py-3 flex justify-center  lg:mx-0 w-80 my-4  lg:w-70'>
                    {
                        props.isLoggedIn ?
