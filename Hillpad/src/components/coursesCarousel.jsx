...
function CoursesCarousel() {
    ...
    return (
        <div className="">
            ...
            <div id="content2" className="carousel flex items-center justify-between overflow-x-auto scroll-smooth no-scrollbar gap-x-6 md:gap-x-2 xl:gap-x-5 2xl:gap-x-2 w-full">
