...
<div>
            <div id="content3" className="carousel flex items-center lg:justify-between overflow-x-auto scroll-smooth  no-scrollbar max-w-full gap-x-2 md:gap-x-6 lg:gap-x-6 xl:mx-4">
                <div className="rounded-t-2xl  xs:ms-1  2xs:mx-0" 
                    ...
                    >
                    <div className="shadow rounded-2xl w-72 xs:w-80 sm:w-72 md:w-56 lg:w-card xl:w-72 2xl:w-card 2xs:mx-7 sm:mx-0 border border-border_white relative ">
                ...
                <div className="rounded-t-2xl mx-2 2xs:mx-0" >
                    <div className="shadow rounded-2xl w-76 2xs:w-80 sm:w-72 md:w-56 lg:w-card xl:w-72 2xl:w-card xs:mx-4 2xs:mx-4 sm:mx-0  border border-border_white">
                        <div className="rounded-2xl">
                ...
                <div className="rounded-t-2xl mx-2 2xs:mx-0">
                    <div className="shadow rounded-2xl w-76 2xs:w-80 sm:w-72 md:w-56 lg:w-card xl:w-72 2xl:w-card xs:mx-2 2xs:mx-4 sm:mx-0  border border-border_white ">
                        <div className="rounded-2xl">
                ...
                <div className="rounded-t-2xl mx-2 2xs:mx-0">
                    <div className="shadow rounded-2xl w-76 2xs:w-80 sm:w-72 md:w-56 lg:w-card xl:w-72 2xl:w-card fxs:mx-4 2xs:mx-4 sm:mx-0  border border-border_white">
                        <div className="rounded-2xl">
