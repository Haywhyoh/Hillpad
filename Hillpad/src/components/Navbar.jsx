  ...
  return (
    ...
    return <MenuItems items={menu} key={index} depthLevel={depthLevel} />;
      ...
      <div className='flex flex-col gap-2  w-11/12 mx-4 lg:w-fit lg:flex-row lg:items-center lg:justify-between'>
        ...
        <Link to='/courses' className='border px-2 border-light_black rounded-lg mb-1 font-semibold text-white text-center border-opacity-10 py-3 bg-orange lg:px-6 lg:border-0 lg:rounded-full lg:py-2 flex items-center gap-x-2'><div>Explore</div> <FaTelegramPlane /></Link>
